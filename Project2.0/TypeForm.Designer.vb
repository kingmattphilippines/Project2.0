...
Partial Class TypeForm
    ...
    Private Sub InitializeComponent()
        Dim resources As ComponentModel.ComponentResourceManager = New ComponentModel.ComponentResourceManager(GetType(TypeForm))
        Panel1 = New Panel()
        Button1 = New Button()
        Panel3 = New Panel()
        ...
        ButtonREMOVE.Location = New Point(366, 470)
        ...
        ButtonEDIT.Location = New Point(201, 470)
        ...
        ButtonADD.Location = New Point(33, 470)
        ...
        TextBoxNAME.Size = New Size(294, 35)
        ...
        TextBoxID.Size = New Size(294, 36)
